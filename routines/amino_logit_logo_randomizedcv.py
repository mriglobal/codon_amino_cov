...
from feature_extraction import AminoFrequencies
...
for split_no,split in enumerate(outer_splits):
    ...
    train_accessions = [a for a in train_meta.loc[train_resample_index]['accession']]
    ...
    pipe_steps.append(('aminos',AminoFrequencies()))
    ...
    print("CV results:")
    print(cv_results)
    feature_vector = grid_search.best_estimator_.named_steps['aminos'].features
